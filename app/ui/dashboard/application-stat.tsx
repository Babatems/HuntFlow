// Used to display a bar chart of monthly application stats for HuntFlow
...
export default async function ApplicationChart() {
  const applicationStats = await fetchApplicationStats();

  const chartHeight = 350;

  const { yAxisLabels, topLabel } = generateYAxis(applicationStats);
